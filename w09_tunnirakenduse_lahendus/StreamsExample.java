...
public class StreamsExample {
    public static void main(String[] args) {
        List<Integer> integerList = Arrays.asList(1, 2, 3, 4, 5, 6, 8, 9, 10);
 ...
 */
            ...
            //rangeClosed annab ka viimase elemendi
/* 
            System.out.println(IntStream.of(2, 4, 6, 8, 10).allMatch(e -> e % 2 == 0));
            System.out.println(IntStream.of(2, 4, 6, 8, 10).anyMatch(e -> e % 2 == 0));
            System.out.println(IntStream.of(2, 4, 6, 8, 10).anyMatch(e -> e % 2 == 0));

            int[] nowArray = new int[] { 1, 2, 3 };

            Arrays.stream(nowArray)
                .map(e -> e * e)
                .average()
                .ifPresent(System.out::println);

 *//* 
            IntStream.of(1, 2, 3, 4, 5, 6).filter(e -> e < 4 ).max().ifPresent(System.out::print);

         
 */


       /*  List<Integer> integerList5 = integerList.stream()
